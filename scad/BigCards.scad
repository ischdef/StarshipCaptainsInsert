...
[
    ...
    [   "card tray - missions",
        [
            ...
            [ BOX_COMPONENT,
                [
                    [ CMP_SHAPE, SQUARE ],
                    [ CMP_COMPARTMENT_SIZE_XYZ, [ 89, 19, 65.0] ],
    ...
    [   "card tray - omega, ereigniskarten, solo",
        [
            [ BOX_SIZE_XYZ,[92.0, 21.0, 68.0] ],
            [ BOX_NO_LID_B,
                [
                    [ ],
                ]
            ...
            [ BOX_COMPONENT,
                [
                    ...
                    [ CMP_COMPARTMENT_SIZE_XYZ, [ 89, 8, 65.0] ],
                    [ CMP_CUTOUT_SIDES_4B, [t,t,f,f]],
